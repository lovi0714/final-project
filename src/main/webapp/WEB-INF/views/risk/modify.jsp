                                ...
                                <div class="row">
                                  	...
                                  	<div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="${risk.title }" id="first-name-vertical" class="form-control" placeholder="리스크 제목을 입력하세요." name="title" maxlength="120">
                                        </div>
                                    </div>
                                	<div class="col-md-6 col-12">
                                    	<div class="form-group">
		                                    ...
		                                    <fieldset class="form-group mt-2">
		                                        <select class="form-select" id="basicSelect" name="rTypeId">
                                	...
                                	<div class="col-md-6 col-12">
                                    	<div class="form-group">
		                                    ...
		                                    <fieldset class="form-group mt-2">
		                                         <select class="form-select" id="basicSelect" name="prjId">
                                	...
                                	<div class="col-md-6 col-12">
                                    	<div class="form-group">
		                                    ...
		                                    <fieldset class="form-group mt-2">
		                                        <select class="form-select" id="basicSelect" name="tName">
                                	...
                                	<div class="col-12">
                                    	<div class="form-group">
                            				...
                            				<textarea class="form-control" id="exampleFormControlTextarea1" name="rContent" rows="3">${risk.rContent }</textarea>
                                        </div>
                                	</div>                          
                                	<div class="col-md-6 col-12">
                                    <div class="form-group">
                                	...
                                	<div class="col-md-6 col-12">
                                    	<div class="form-group">
                                            <label for="basicSelect">조치 희망일</label>
                                          	<input type="date" id="first-name-vertical" class="form-control mt-2" name="dueAt">
                                        </div>
                                	</div>
                                	<div class="col-12">
                                    	<div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="first-name-vertical" class="form-control" placeholder="산출물 제목을 입력하세요." name="rFile" maxlength="120">
                                        </div>
                                    </div>
                                    <div class="col-md-1">
					                    <fieldset class="form-group">
					                    <label for="basicSelect">진행 상태</label>
					                        <select class="form-select" id="basicSelect" name="rStatusId" style="background-color:white; margin-top:5px;">
