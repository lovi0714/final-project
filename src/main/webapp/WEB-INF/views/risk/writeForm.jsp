            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="${path}/risk/create.do" method="post">
                                <div class="row">
       
                                  	<div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="first-name-vertical" class="form-label">리스크 제목</label>
                                            <input type="text" id="first-name-vertical" class="form-control" placeholder="리스크 제목을 입력하세요." name="title" maxlength="120">
                                        </div>
                                    </div>
                                	<div class="col-md-6 col-12">
                                    	<div class="form-group">
                                	...
                                	<div class="col-12">
                                    	<div class="form-group">
                            				...
                            				<textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="rContent"></textarea>
                                        </div>
                                	</div>                          
                                	<div class="col-md-6 col-12">
                                    <div class="form-group">
