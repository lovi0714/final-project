...
<div class="error-page container">
    <div class="col-md-8 col-12 offset-md-2">
        <img class="img-error" src="${path}/resources/images/samples/error-404.png" alt="Not Found">
        <div class="text-center">
            <h1 class="error-title">페이지를 찾을수 없음.</h1>
            <p class='fs-5 text-gray-600'>요청한 페이지를 찾을수 없습니다.</p>
